...
./algebraic.py $opts --save roots-4-35.dat --coeff 35 --degrees 4
./algebraic.py $opts --save roots-5-22.dat --coeff 22 --degrees 5
./algebraic.py $opts --save roots-6-18.dat --coeff 18 --degrees 6
