...
./algebraic.py $opts --save roots-4-45.dat --coeff 45 --degrees 4
./algebraic.py $opts --save roots-5-30.dat --coeff 30 --degrees 5
./algebraic.py $opts --save roots-6-20.dat --coeff 20 --degrees 6
...
./algebraic.py $opts --load roots-1-100.dat --load roots-2-100.dat --load roots-3-60.dat --load roots-4-45.dat --load roots-5-30.dat --load roots-6-20.dat --load roots-7-15.dat --load roots-8-12.dat --load roots-9-10.dat --draw $pic
